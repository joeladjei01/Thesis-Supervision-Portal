...
const UploadTemplate: React.FC = () => {
  ...
  return (
    <div className="w-full ">
      <div className="bg-white dark:bg-transparent rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            ...
            <tbody className="bg-white dark:bg-transparent divide-y divide-gray-200">
              {students.map((student, index) => (
                <tr
                  ...
                  className={` text-blue-900 border-gray-200 dark:text-white  transition-colors duration-150 ${

...
const UploadHistory: React.FC = () => {
  ...
  return (
    <div className="w-full">
      <div className="bg-white dark:bg-transparent dark:text-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        <div className="overflow-x-auto">
          <table className="min-w-full dark:text-white divide-y divide-gray-200">
            ...
            <tbody className="bg-white dark:bg-transparent divide-y divide-gray-200">
              {fileRecords.map((record, index) => (
                <tr key={index} className=" text-blue-900 transition-colors duration-150 dark:bg-transparent dark:text-white">

...
const FileUpload: React.FC<FileUploadProps> = ({
  ...
  const handleBulkSubmit = async () => {
    ...
    if (selectedFile) {
      ...
      submitFormData.append("role", StudentRole);
  ...
  const handleDownloadTemplate = () => {
    const fileUrl = "/students.csv"; // Path to the file in the public directory
    ...
    <div className="w-full">
      <div
        className={`
          ...
          relative border-2 z-0 border-dashed rounded-lg p-12 text-center transition-all duration-200
          ${
            isDragOver
        ...
        <div className="space-y-4">
          <div className="flex justify-center">
            <div className="flex items-center justify-center">
              <Upload className="w-16 h-16 text-blue-900 dark:text-blue-200" />
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <button
              ...
              className="border z-50 border-gray-300 text-gray-700 px-6 py-1 rounded-lg font-medium hover:bg-gray-50 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 flex items-center space-x-2"
            >
          ...
          <button
            onClick={() => mutate()}
            className="border border-gray-300 text-white bg-primary px-4 py-2 rounded-lg ml-auto mr-auto font-medium  transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 flex items-center space-x-2

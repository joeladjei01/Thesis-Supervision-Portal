...
export default function Auth({ children }: { children: ReactNode }) {
  return (
    <div className="flex h-screen w-full flex-1 bg-white dark:bg-background transition-colors duration-300">
      <div className="size-9 rounded-full  flex items-center justify-center bg-gray-100 dark:bg-gray-700 absolute bottom-5 right-5">
        ...
        <div className="mx-auto w-full max-w-sm lg:w-96">
          <div className="max-w-full flex flex-col items-center">
            ...
            <h2 className="text-3xl mt-2 text-primary dark:text-gray-100 font-outfit font-bold text-center">
              Thesis Supervision <span className="text-secondary dark:text-gray-400 font-normal">Portal</span>
            </h2>
            <div className="flex justify-center gap-1 w-full mt-2">
              <div className="h-1 rounded-full w-40 bg-gray-200 dark:bg-blue-900/30" />
              <div className="h-1 rounded-full w-12 bg-secondary dark:bg-gray-400" />
            </div>
            <p  className="font-outfit text-xl mt-2 text-gray-600 dark:text-blue-400 font-normal" >(ThesisFlow)</p>
          </div>
